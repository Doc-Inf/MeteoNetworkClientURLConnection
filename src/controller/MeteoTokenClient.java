...
public class MeteoTokenClient {
	...
	public MeteoTokenClient(String requestURL, String charset, Map<String, String> headers) throws Exception{
		super();
		...
		log("Inizializzazione del Client terminata");
	}
